...
const members = [
    ...
    },
    {
        ...
        id: "2380601806",
        phone: "0796659071",
        email: "nguyencongquang02082003@gmail.com"
    },
    {
        ...
        id: "2380681640",
        phone: "0971840346",
        email: "tinal27725@gmail.com"
    },
    {
        name: "Nguyễn Thanh Bảo Ngân",
        role: "Thành viên",
        id: "2380601424",
        phone: "0329336782",
        email: "baongan05289@gmail.com"
    },
    {
        name: "Ngô Nguyễn Thu Hương",
        role: "Thành viên",
        id: "2380600942",
        phone: "0937889356",
        email: "ngo24616@gmail.com"
    },
    {
        name: "Trương Thị Yến Nhi",
        role: "Thành viên",
        id: "2380601581",
        phone: "0386431044",
        email: "yennhitruong704@gmail.com"
    },
    {
        ...
        id: "2380613311",
        phone: "0798116277",
        email: "nguyenphuongnam16112005@gmail.com"
    },
    {
        name: "Ngô Cẩm Nhung",
        role: "Thành viên",
        ...
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="relative group">
                ...
                <div className="relative px-8 py-10 bg-card rounded-2xl border border-white/5 flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="text-center md:text-left">
                        <h2 className="text-3xl font-extrabold tracking-tight text-white mb-2">Nhóm: Xóm Nhà Lá</h2>
                        <p className="text-muted-foreground text-lg max-w-2xl leading-relaxed">
                            Chúng tôi là đội ngũ sinh viên đam mê công nghệ, cam kết mang đến những giải pháp dịch thuật thời gian thực tối ưu nhất thông qua trí tuệ nhân tạo.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 bg-secondary/20 rounded-xl border border-white/5">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-xl font-bold">Về Dự Án</h3>
                    </div>
                    <ul className="space-y-3 text-muted-foreground">
                        <li className="flex items-start gap-2">
                            <span className="text-blue-400 mt-1.5">•</span>
                            <span>Dịch thuật âm thanh thời gian thực (Real-time Speech Translation).</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <span className="text-blue-400 mt-1.5">•</span>
                            <span>Hệ thống AI xử lý nội bộ (Local AI Server) đảm bảo quyền riêng tư.</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <span className="text-blue-400 mt-1.5">•</span>
                            <span>Tự động tối ưu hóa dựa trên cấu hình phần cứng.</span>
                        </li>
                    </ul>
                </div>
                <div className="p-6 bg-secondary/20 rounded-xl border border-white/5">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-xl font-bold">Quy Mô Nhóm</h3>
                    </div>
                    <p className="text-muted-foreground leading-relaxed">
                        Với đội ngũ 8 thành viên, chúng tôi chia sẻ các vai trò từ nghiên cứu mô hình AI (ASR, MT, TTS) đến phát triển ứng dụng di động và giao diện web hiện đại.
                    </p>
                    <div className="mt-4 flex gap-4">
                        <div className="text-center px-4 py-2 bg-white/5 rounded-lg border border-white/10">
                            ...
                            <div className="text-xs text-muted-foreground uppercase tracking-wider">Thành viên</div>
                        </div>
                        <div className="text-center px-4 py-2 bg-white/5 rounded-lg border border-white/10">
                            <div className="text-2xl font-bold text-white">03</div>
                            <div className="text-xs text-muted-foreground uppercase tracking-wider">Lĩnh vực AI</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-2xl font-bold tracking-tight">Chi Tiết Thành Viên</h3>
                </div>
